...
<section className="bg-white dark:bg-gray-900">
  <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
    <div className="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8">
      ...
      <p className="font-light text-gray-500 sm:text-xl dark:text-gray-400">Any Info about the Website, Novels goes here.</p>
    </div> 
    <div className="grid gap-8 lg:grid-cols-2">
      <article className="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
        ...
        <h2 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"><a href="#">Random Novel Info Here</a></h2>
        <p className="mb-5 font-light text-gray-500 dark:text-gray-400">Just some Filler info goes here.</p>
        <div className="flex justify-between items-center">
          <div className="flex items-center space-x-4">
            <img className="w-7 h-7 rounded-full" src="" alt="avatar" />
      ...
      <article className="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
        ...
        <h2 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"><a href="#">Info About the site</a></h2>
        <p className="mb-5 font-light text-gray-500 dark:text-gray-400">Site Info Goes here... A Bunch of Filler info goes here idk what else to type for filler. I suppose I could do Lorum ipsum stuff.</p>
        <div className="flex justify-between items-center">
          <div className="flex items-center space-x-4">
            <img className="w-7 h-7 rounded-full" src="" alt="avatar" />
            <span className="font-medium dark:text-white">
